...
<body>
    <div>
        ...
        <form id="add" action="rei26.php" name="update" method="post">
        ...
        <div>
            ...
            if (!empty($_POST['data'])) {
                ...
                file_put_contents('rei26.txt', $data, FILE_APPEND | LOCK_EX);

            }
            $data = file_get_contents('rei26.txt');
            echo nl2br($data);
            ?>
        </div>
    </div>
